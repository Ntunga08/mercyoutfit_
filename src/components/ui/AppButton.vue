...
const variants = {
  ...
  soft: 'bg-teal-soft text-teal hover:bg-[#f5ebc8]',
}
...
<template>
  <button
    ...
    class="inline-flex items-center justify-center gap-2 rounded-xl font-semibold transition disabled:cursor-not-allowed disabled:opacity-50"
